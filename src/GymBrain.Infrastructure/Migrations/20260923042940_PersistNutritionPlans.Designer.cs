...
namespace GymBrain.Infrastructure.Migrations
{
    ...
    [Migration("20260923042940_PersistNutritionPlans")]
    partial class PersistNutritionPlans
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GymBrain.Domain.Entities.AnalyticsEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GymBrain.Domain.Entities.Exercise", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("10000001-0000-0000-0000-000000000066"),
                            Category = "Warmup",
                            CreatedAtUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DefaultBeginnerWeightKg = 0.0,
                            Equipment = "cardio",
                        ...
                        new
                        {
                            Id = new Guid("10000001-0000-0000-0000-000000000067"),
                            Category = "Warmup",
                            CreatedAtUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DefaultBeginnerWeightKg = 0.0,
                            Equipment = "cardio",
                        ...
                        new
                        {
                            Id = new Guid("10000001-0000-0000-0000-000000000068"),
                            Category = "Warmup",
                            CreatedAtUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DefaultBeginnerWeightKg = 0.0,
                            Equipment = "bodyweight",
                        ...
                        new
                        {
                            Id = new Guid("10000001-0000-0000-0000-000000000069"),
                            Category = "Warmup",
                            CreatedAtUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DefaultBeginnerWeightKg = 0.0,
                            Equipment = "bodyweight",
                        ...
                        new
                        {
                            Id = new Guid("10000001-0000-0000-0000-000000000070"),
                            Category = "Warmup",
                            CreatedAtUtc = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DefaultBeginnerWeightKg = 0.0,
                            Equipment = "bodyweight",
            ...
            modelBuilder.Entity("GymBrain.Domain.Entities.NutritionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GymBrain.Domain.Entities.NutritionPlan", b =>
                {
                    b.HasOne("GymBrain.Domain.Entities.User", null)
                        .WithMany()
